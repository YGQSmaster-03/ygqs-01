...
def main():
    try:
        # 使用示例
        video_name = "weibo_720P"
        input_video = f"input/{video_name}.mp4"
...
""" 
@2025年01月16日14:47:06
文件路径: input/weibo_720P.mp4
分辨率: 1280x720
帧率: 29 fps
总帧数: 5491
时长: 3分9秒
文件大小: 32.68 MB   处理后视频大小：252.6MB

请在视频第一帧中选择水印区域...
已选择水印区域: x=43, y=43, width=297, height=76
处理进度:  98%|█████████▊| 5355/5491 [05:43<00:08, 15.58it/s]
视频处理完成，已保存至: output/weibo_720P_no_watermark.mp4
"""